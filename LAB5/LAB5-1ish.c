...
{	
	...
	setup_dac((uint32_t)&data,(uint32_t)0x0320);
...
DMA_CTRL=DMA_ENABLE_bm | DMA_CH_BURSTLEN_2BYTE_gc;

DMA_CH0_ADDRCTRL=	DMA_CH_SRCDIR_FIXED_gc | DMA_CH_DESTDIR_FIXED_gc |DMA_CH_SRCRELOAD_BLOCK_gc | DMA_CH_DESTRELOAD_BURST_gc;
